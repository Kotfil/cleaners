...
import {ForgotFormEmailProps} from '@/app/components/auth/forgot-form/forgot-form-email/forgot-form-email.types';
import {ErrorMessage} from "@/app/components/ui/error-message";

export function ForgotFormEmail({
                                   isLoading,
                                   errorMessage,
                                   isTouched
                               }: ForgotFormEmailProps) {
